  ...
  <div class="row d-flex flex-row mr-2 pr-2">
    ...
    <div class="col-md-12 col-sm-6">
      ...
      <h5 class="form-control ml-6 alert-info" v-show="!isAuthenticated">
        You're not logged in! Please login as a <strong>Client</strong> to
        request rides.
      </h5>
    </div>
    <div
      ...
      <ul class="list-group">
        ...
        >
          ...
          <span class="badge bg-primary rounded-pill">
            <button
              @click="setDestination((destination = dest))"
              type="button"
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form @submit.prevent="confirmDriver()">
                <div class="mb-3">
...
export default {
  ...
  mounted() {
    ...
    console.log("Status:" + localStorage.getItem("Client"));
    if (
  ...
  methods: {
    ...
    confirmDriver() {
      ...
      this.$router.push({
        name: "Drivers",
        params: { from: this.from, destination: this.destination },
      });
      localStorage.setItem("from", this.from);
      localStorage.setItem("dest", this.destination);
      this.$refs["exampleModal"].close();
    },
    setDestination(dest) {
      this.destination = dest;
      //alert("You have selected " + dest + " click okay to proceed!");
    },
